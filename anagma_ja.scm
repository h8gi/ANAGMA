...
(use coops srfi-13 regex easy-args extras utils utf8)

;;; ローターの変換規則
(define (random-string str)
  (let ((len (string-length str)))
    ))

(define upper-set "あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわをんがぎぐげござじずぜぞだぢづでどばびぶべぼぱぴぷぺぽゃゅょ")
